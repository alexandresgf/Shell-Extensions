...
var Task = GObject.registerClass({
    Signals: {
        'delete_signal': {},
        'update_signal': {},
        'stop_signal': {},
    ...
    class Task extends PopupMenu.PopupMenuItem {
        _init(task) {
            ...
            this.add_style_class_name("task");
            ...
            this.add_actor(this.durationLabel);
        ...
        _update(loop = true){
            ...
            if (this.task.currTime == duration){
                ...
                if (this.task.currTime % 2 == 0){
                    this.set_style('background-color:' + this.task.color + '; background-position: 400px 0px;');
                } else {
                    this.set_style('background-position: 400px 0px;');
                }
            } else {
